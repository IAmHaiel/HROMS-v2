...
namespace OTMS.Service.Interfaces
{
    public interface IAccountManagementService
    {
        ...
        Task<ApiResponseDTO<PaginationResponseDTO<EmployeeAttachmentDTO>>> GetAllEmployeeDocuments(PaginationDTO request, string? search, string? documentType, bool? isArchived);
