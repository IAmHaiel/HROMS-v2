...
{
    /// <inheritdoc />
    public partial class DynamicRBACAndOrganization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeAttachmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAttachments", x => x.EmployeeAttachmentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    PermanentlyDeleted = table.Column<bool>(type: "bit", nullable: false),
